...
{
    if (pindexBest->nHeight <= forkblock)
        return 350;
    else
        return 40;
}
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "9 March Reecoin";
        CTransaction txNew;
        txNew.nTime = 1457564436;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1457564436;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1524904;
...
// This will figure out a valid hash and Nonce if you're
        ...
        //// debug print
        ///
        assert(block.hashMerkleRoot == uint256("0xc771ec1a75832a5650ee40b5cbe47bb451f4aa0cbe4c51fb84ad3f68034a45d7"));
        block.print();
